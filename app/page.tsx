...
export default function LandingPage() {
  return (
   <main className="min-h-screen bg-gradient-to-b from-white to-gray-50/50 flex items-center justify-center">
    ...
    <section className="w-full px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8
    flex flex-col items-center space-y-10 text-center">
      {/* Hero content */}
      <header className="w-full max-w-3xl text-center space-y-6">
  ...
  Powered by IBM&apos;s WxTools & Claude 3.5.
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 pt-8 max-w-3xl mx-auto">
        {[
          { title: "Fast", description: "Real-time stream responses"},
          { title: "Modern", description: "Next.js, Tailwind CSS, Convex, Clerk"},
          { title: "Smart", description: "Powered by LangChain"},
